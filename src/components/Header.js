        ...
        <Default>
          <div>
            <p className="App-intro">
              <Link to='/'><FlatButton label="Home" labelStyle={{fontSize:20}}  style={buttonStyle} hoverColor="#7aca45" rippleColor="#2c9ee7"/></Link>
              ...
              <Link to='/signup'><FlatButton label="Sign Up" labelStyle={{fontSize:20}} style={buttonStyle} hoverColor="#7aca45" rippleColor="#2c9ee7"/></Link>
